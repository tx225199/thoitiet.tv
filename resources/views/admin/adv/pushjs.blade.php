                        ...
                        @if (!empty($data))
                            @foreach ($data as $key => $item)
                                <tr class="tr-{{ $item->id }}">
                                    ...
                                    <td><a class="btn btn-success btn-sm" style="font-weight:bold;">{{ $item->type }}</a>
                                    </td>
                                    <td><a>{{ Str::words($item->script, 20, '....') }}</a></td>
            ...
            <form class="modal-content" id="formData_add" method="POST" action="{{ route('admin.adv.store') }}"
                ...
                <div class="modal-body">
                    ...
                    <div class="form-group clearfix">
                        ...
                        <textarea name="script" id="script" placeholder="Nhúng mã quảng cáo"></textarea>
                    </div>
                </div>
