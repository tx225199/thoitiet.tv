                                ...
                                <tr class="tr-{{ $item->id }}">
                                    ...
                                    <td>
                                        @if ($item->des_media != '')
                                            <span>
                                                <a target="_blank"
                                                    href="{{ route('web.adv.banner', ['path' => $item->des_media]) }}">Desktop</a>
                                            </span>
                                        @endif
                                        ...
                                        @if ($item->mob_media != '')
                                            ...
                                            <span>
                                                <a target="_blank"
                                                    href="{{ route('web.adv.banner', ['path' => $item->mob_media]) }}">Mobile</a>
                                            </span>
                                        @endif
                                    </td>
            ...
            <form class="modal-content" id="formData_add" method="POST" action="{{ route('admin.adv.store') }}"
                ...
                <div class="modal-body">
                        ...
                        <div class="col-md-4">
                            <div class="form-group clearfix">
                                ...
                                <select name="position[]" class="select2" multiple>
                                    <option value="top">Đầu</option>
                                    <option value="sidebar_right">Bên phải (lớn)</option>
                                    <option value="sidebar_right_sm">Bên phải (nhỏ)</option>
                                    <option value="fixed">Fix cứng</option>
                                </select>
                            </div>
                        </div>
                    ...
                    <div class="form-group clearfix">
                        ...
                        <input name="link" type="link" class="form-control" placeholder="https://bet88.com"
                            autocomplete="off">
                    </div>
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group clearfix">
                                <label class="control-label">Màn máy tính: </label>
                ...
                <div class="modal-dialog modal-lg">
                    <form class="modal-content" method="POST" action="{{ route('admin.adv.store') }}"
                        ...
                        <div class="modal-body">
                                ...
                                <div class="col-md-4">
                                    <div class="form-group clearfix">
                                        ...
                                        <select name="position[]" class="select2" multiple required>
                                            ...
                                            <option value="top" {{ in_array('top', $positions) ? 'selected' : '' }}>Đầu</option>
                                            <option value="sidebar_right" {{ in_array('sidebar_right', $positions) ? 'selected' : '' }}>Bên phải (lớn)</option>
                                            <option value="sidebar_right_sm" {{ in_array('sidebar_right_sm', $positions) ? 'selected' : '' }}>Bên phải (nhỏ)</option>
                                            <option value="fixed" {{ in_array('fixed', $positions) ? 'selected' : '' }}>Fix cứng</option>
                                        </select>
                                    </div>
                                </div>
                            ...
                            <div class="form-group clearfix">
                                <label class="control-label">Liên kết:</label>
                                <input name="link" type="link" value="{{ $item->link }}" class="form-control"
                                    placeholder="https://bet88.com" autocomplete="off">
                            </div>

                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group clearfix">
                                        <label class="control-label">Media máy tính: </label>
                                        <input name="des_media" type="file" class="form-control" autocomplete="off">
                                    </div>
                                </div>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group clearfix">
                                        <label class="control-label">Media điện thoại: </label>
                                        <input name="mob_media" type="file" class="form-control" autocomplete="off">
                                    </div>
                                </div>
                            </div>
