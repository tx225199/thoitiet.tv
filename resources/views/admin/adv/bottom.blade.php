...
@section('title')
    <title>Quản trị | Quảng cáo | Bottom</title>
            ...
            <form class="modal-content" id="formData_add" method="POST" action="{{ route('admin.adv.store') }}"
                ...
                <div class="modal-body">
                    ...
                    <div class="form-group clearfix">
                        ...
                        <textarea name="script" id="script" placeholder="Mã quảng cáo"></textarea>
                    </div>
                </div>
                ...
                <div class="modal-dialog modal-lg">
                    <form class="modal-content" method="POST" action="{{ route('admin.adv.store') }}"
                        ...
                        <div class="modal-body">
                            ...
                            <div class="form-group clearfix">
                                <label class="control-label">Script quảng cáo: </label>
                                <textarea name="script" id="script" placeholder="Mã quảng cáo">{{ $item->script }}</textarea>
                            </div>
                        </div>
                        <div class="modal-footer">
