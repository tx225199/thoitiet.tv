...
class SettingSeeder extends Seeder
{
    public function run(): void
    {
        $defaults = [
            ...
            'site_name'         => 'thoitietvn.net',
            'version'           => '1.0',
            'theme_color'       => '#1e62b5', // xanh thời tiết
            'google_analytics'  => '',
            'microsoft_clarity' => '',
            'mail'              => 'contact@thoitietvn.net',
            'description'       => 'ThoitietVn.Net – Cập nhật dự báo thời tiết theo giờ, theo ngày cho 63 tỉnh thành Việt Nam. Xem nhiệt độ, cảm giác như, độ ẩm, gió, tầm nhìn, UV và cảnh báo thời tiết.',
            'introduce'         => "thoitietvn.net là trang tra cứu thời tiết nhanh và dễ dùng cho 63 tỉnh thành Việt Nam.\nBạn có thể xem dự báo theo giờ, theo ngày, chỉ số UV, gió, độ ẩm, tầm nhìn và các cảnh báo thời tiết.\nDữ liệu được cập nhật liên tục để bạn chủ động kế hoạch di chuyển và sinh hoạt.",
            'copyright'         => '© 2026 thoitietvn.net. All rights reserved.',
            'notification'      => '☁️ Xem dự báo thời tiết hôm nay & 7 ngày tới trên thoitietvn.net',
